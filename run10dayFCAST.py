...
rawdf = pd.read_csv('NDVA_VGT_Oct31_2024.csv',sep='\t')
...
nPointsToBacktest = 42 # 504 # Excel S15
...
# one hyperparam value (for forward forecast)
if True:
  for nPointsInRegressionNominal in [30]:
    for momentWindowSizeNominal in [150]:
      for alphaNominal in [0.0003]:
        oneBacktest(momentWindowSizeNominal, nPointsInRegressionNominal, alphaNominal)
